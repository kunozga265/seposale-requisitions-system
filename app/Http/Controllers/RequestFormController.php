        ...
        if (is_object($summary)) {
            ...
            if ($request->expenses["transportation"]["check"]) {
                ...
                $items[] = [
                    ...
                    "unitCost" => $request->expenses["transportation"]["amount"] / $request->expenses["transportation"]["quantity"],
            ...
            if ($request->expenses["product"]["check"]) {
                $items[] = [
                    ...
                    "unitCost" => $request->expenses["product"]["amount"] / $request->expenses["product"]["quantity"],
