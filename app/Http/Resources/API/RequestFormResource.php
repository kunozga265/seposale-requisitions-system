...
use App\Http\Resources\RequestFormItemResource;
    ...
    public function toArray($request)
    {
       ...
       $canApproveOrDeny=$this->user->id != $user->id && $this->approvalBy == null && $this->approvalStatus!=2 && $nextApprove;
        ...
        return [
            ...
            'dateRequested'                       =>  intval($this->dateRequested),
            ...
            'approvedDate'                        =>  intval($this->approvedDate),
            'dateInitiated'                       =>  intval($this->dateInitiated),
            'dateReconciled'                      =>  intval($this->dateReconciled),
            ...
            'deniedBy'                            =>  new UserResource($this->deniedBy),
            'editable'                            =>  $this->editable == 1 ? true : false,
