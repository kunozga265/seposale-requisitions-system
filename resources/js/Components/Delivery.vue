            ...
            <template #content>
                <div class="delivery-profile grid grid-cols-1 md:grid-cols-2 gap-2">
                    ...
                    <div v-show="delivery.status === 1" class="mb-4">
                        ...
                        <jet-input :max="quantityBalance" type="number"  class="block w-full" v-model="form.quantity"/>
                  ...
                  <div class="mb-4 md:col-span-2" >
                    ...
                    <div class="mb-4 md:col-span-2" >
                        <div @click="showLogs = !showLogs" class="text-mute transition-all ease-in">
                            <i class="text-lg mdi" :class="{'mdi-menu-down':!showLogs, 'mdi-menu-up': showLogs}"></i> Logs ({{delivery.logs.length}})
                        </div>
                    ...
                    <div v-if="delivery.status === 1" @click="openDeleteDialog" class="mb-4 md:col-span-2 text-red-500 text-sm cursor" >
                        <i
                           class="mdi mdi-close-circle text-red-600 focus:ring-4 focus:outline-none focus:ring-red-300 "></i> Cancel Delivery
                    </div>
