    ...
    <div class="mt-4 flex flex-col items-center">
        ...
        <span class="text-sm text-gray-700 dark:text-gray-400">
            Showing <span class="font-semibold text-gray-900 dark:text-white">{{
                object.meta.from
            }}</span> to <span class="font-semibold text-gray-900 dark:text-white">{{ object.meta.to }}</span> of
        ...
        <div class="inline-flex mt-2 xs:mt-0">
            <!-- Previous Button -->
            <a v-show="object.links.prev != null" :href="prev()"
            ...
            <a v-show="object.links.next != null" :href="next()"
...
export default {
    ...
    methods: {
        prev() {
            if (this.params != null) {
                return this.object.links.prev + '&' + this.params
            } else {
                return this.object.links.prev
            }
        },
        next() {
            if (this.params != null) {
                return this.object.links.next + '&' + this.params
            } else {
                return this.object.links.next
            }
        }
    }
}
