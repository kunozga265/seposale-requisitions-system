                ...
                <div class="p-2 mb-2 relative ">
                  ...
                  <table class="w-full  text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tr
                      ...
                      <td class="p-2 text-left ">{{ account.group.type.statement == "balance-sheet" ? "Balance Sheet" : "Income Statement" }}</td>
    ...
    filteredAccounts() {
      ...
      if (this.form.name.length !== 0) {
        filtered = (filtered).filter((account) => {
            ...
            return account.name.toLowerCase().includes(this.form.name.toLowerCase())
