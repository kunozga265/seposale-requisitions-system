<template>
  <app-layout>
    ...
    <template #breadcrumbs>
      <li aria-current="page">
        <div class="flex items-center">
          ...
          <span class="heading-font uppercase text-sm font-medium text-gray-500 dark:text-gray-400">Clients</span>
        </div>
      </li>
    </template>
    ...
    <template #actions>
      ...
      <secondary-button v-show="listOfClients.length > 1" @click.native="merge">
        Merge
      </secondary-button>
      ...
      <div class="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
        ...
        <div class="page-section">
          ...
          <div class="page-section-content">
            ...
            <div v-if="clients.data.length === 0" class="text-center text-gray-400 md:col-span-2 text-sm">
              No Clients Found
            </div>
            <div v-else>
              <div class="card">
	...
	l21.186-23.834c1.766-2.648,2.648-6.179,1.766-8.828l-25.6-57.379C193.324,138.593,190.676,135.945,187.145,135.945" />
                    ...
                    <tbody class="pt-8">
                      ...
                      <tr class="border-b cursor-pointer hover:bg-gray-100 transition ease-in-out duration-200"
                        ...
                        <td @click="navigateToClient(client.id)" class="p-2 text-center ">

                          <input checked id="backdate" type="checkbox" disabled v-model="client.organisation"
                            class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">

                        </td>
                        <td @click="navigateToClient(client.id)" class="p-2 text-left ">{{ client.phoneNumber }}</td>
                        <td @click="navigateToClient(client.id)" class="p-2 text-left ">{{ client.phoneNumberOther }}
                        </td>
  ...
  methods: {
    ...
    selectClient(id) {
      ...
      if (this.listOfClients.includes(id)) {
        ...
        if (index > -1) {
          this.listOfClients.splice(index, 1); // 2nd parameter means remove one item only
        }
