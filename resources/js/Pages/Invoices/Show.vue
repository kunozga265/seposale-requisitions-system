                        ...
                        <div class="page-section-content">
                            <div class="card p-0">
                                ...
                                <div class="border-b px-4 py-3 flex justify-between text-sm">
                                    ...
                                    <div>{{ invoice.data.sale.localPurchaseOrder }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="pt-4 pr-1 text-base font-bold">
                                                    {{ numberWithCommas(invoice.data.sale.total) }}</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
    ...
    data() {
        return {
            ...
            form: this.$inertia.form({
                localPurchaseOrder: this.invoice.data.sale.localPurchaseOrder != null ? this.invoice.data.sale.localPurchaseOrder : "",
    ...
    methods: {
        ...
        attachPurchaseOrder() {
            this.form
                ...
                .post(this.route('sales.attach-purchase-order', { 'id': this.invoice.data.sale.id }), {
                    preserveScroll: true,
