...
export default {
  ...
  data() {
    return {
      vatOption: this.quotation.data.vatOption,
      checkClient: "existing",
      addRecordDialog: false,
      productIndex: -1,
      clientIndex: -1,
      selectedClient: this.quotation.data.client,
      addRecordUnits: "",
      addRecordQuantity: 0,
      addRecordUnitCost: 0,
      vatRate: 0.175,
      calculateVat: this.quotation.data.vat > 0,
      form: this.$inertia.form({
        ...
        notes: this.quotation.data.meta?.notes,
