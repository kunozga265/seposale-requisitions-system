  ...
  <app-layout>
    ...
    <template #actions>
      <div class="flex items-center">
        ...
        <danger-button
          v-if="checkRole($page.props.auth.data, 'management') || checkRole($page.props.auth.data, 'accountant')"
          class="ml-1" @click.native="deleteDialog = true">Delete</danger-button>
      </div>
    ...
    <dialog-modal :show="deleteDialog" @close="deleteDialog = false">
      ...
      <template #content>
        ...
        Once you delete, this receipt will no longer be available.
      </template>
      ...
      <template #footer>
        ...
        <danger-button class="ml-2" @click.native="deleteReceipt">
    ...
    <div class="py-6">
      <div class="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
        ...
        <div>
            ...
            <div class="page-section-content">
              <div class="card p-0">
                ...
                <div v-if="siteSale != null">
                  <inertia-link
                    :href="route('sites.sales.show', { 'code': siteSale.data.site.code, 'id': siteSale.data.id })">
                    <div class="border-b px-4 py-3 flex justify-between text-sm">
                      <div class="text-gray-600 font-semibold">Sale Code</div>
                  ...
                  <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                      <tr
                        ...
                        v-for="(info, index) in receipt.data.summaries" :key="index">
          ...
          <div class="page-section">
            <div class="page-section-content">
              <div class="card p-0" v-if="receipt.data.generatedBy != null">
                ...
                <div class="border-b px-3 py-2 flex justify-between text-sm">
                  ...
                  <div>{{ receipt.data.generatedBy.fullName }}</div>
                </div>
                <div class="border-b px-3 py-2 flex justify-between text-sm">
...
export default {
  ...
  methods: {
    ...
    deleteReceipt() {
      this.form
        .delete(this.route('receipts.destroy', { 'id': this.receipt.data.id }), {
          preserveScroll: true,
