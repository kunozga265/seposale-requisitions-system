  ...
  <app-layout>
    ...
    <template #actions>
      <div class="flex items-center">
        ...
        <danger-button v-if="checkRole($page.props.auth.data, 'management') || checkRole($page.props.auth.data, 'accountant')" class="ml-1" @click.native="deleteDialog = true">Delete</danger-button>
      </div>
