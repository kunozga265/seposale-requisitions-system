<template>
    <app-layout>
        ...
        <div class="mx-9 flex">
            ...
            <a :href="route('reports.statements', { section: 'overview' })">
            ...
            <a :href="route('reports.statements', { section: 'balance-sheet' })">
                <div class="flex items-center rounded-full py-2 px-3 bg-gray-200 text-gray-600 text-xs font-bold "
            ...
            <a :href="route('reports.statements', { section: 'income-statement' })">
                <div class="flex items-center rounded-full py-2 px-3 bg-gray-200 text-gray-600 text-xs font-bold "
                ...
                <div class="page-section" v-if="section === 'overview'">
                    ...
                    <div class="page-section-content ">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-2">
                            ...
                            <inertia-link :href="route('reports.statements.show',{serial:balanceSheet.serial})" class="card mb-0 no-shadow">
                            ...
                            <inertia-link :href="route('reports.statements.show',{serial:incomeStatement.serial})" class="card mb-0 no-shadow">
                                <div class="flex justify-between items-center">
                                    <div class="p-4">
