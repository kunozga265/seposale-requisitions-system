    ...
    <app-layout>
        ...
        <div class="mx-9 flex justify-between">
            ...
            <div class="view-options">
                ...
                <inertia-link :class="{ 'active': section === 'block' }"
                    :href="route('sales.index', { section: 'block' })">
        ...
        <div class="py-6">
            <div class="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
                ...
                <div v-else>
                    <div v-if="awaitingConfirmation.data.length > 0" class="page-section">
                        <div class="page-section-header">
                            <div class="page-section-title">
                        ...
                        <div class="page-section-content">
                            <div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2">
                                    <inertia-link :href="route('sales.show', { id: sale.id })"
                                        v-for="(sale, index) in awaitingConfirmation.data" :key="index">
                                        <div class="app-card">
                                            <div class="header justify-between items-center border-b">
                                                <div>
                                                    <div>
                                ...
                                <div class="flex flex-col items-center">
                                    ...
                                    <span class="text-sm text-gray-700 dark:text-gray-400">
                                        Showing <span class="font-semibold text-gray-900 dark:text-white">{{
                                            awaitingConfirmation.meta.from
                                            }}</span> to <span class="font-semibold text-gray-900 dark:text-white">{{
                                                awaitingConfirmation.meta.to
                                            }}</span> of <span class="font-semibold text-gray-900 dark:text-white">{{
                                                awaitingConfirmation.meta.total
                                            }}</span> Sales
                                    </span>
                                    <div class="inline-flex mt-2 xs:mt-0">
                                        <!-- Previous Button -->
                                        <a :href="awaitingConfirmation.links.prev"
                                            class="inline-flex items-center px-4 py-2 mr-3 text-sm font-medium text-gray-500 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
                                            <svg aria-hidden="true" class="w-5 h-5 mr-2" fill="currentColor"
                                                viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd"
                                        ...
                                        <a :href="awaitingConfirmation.links.next"
                                            class="inline-flex items-center px-4 py-2 text-sm font-medium text-gray-500 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
                                            Next
                                            <svg aria-hidden="true" class="w-5 h-5 ml-2" fill="currentColor"
                                                viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <thead
                                            ...
                                            <tr>
                                                ...
                                                <th scope="col" class="p-2 pb-4 heading-font text-left"><select
                                                        v-model="form.paymentStatus" id="payment-status"
                                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                                                        required>
                                                        <option v-for="(status, index) in paymentStatuses"
                                                            :value="status.value" :key="index">
                                                            {{ status.name }}
                                                        </option>
                                                    </select></th>
                                                <th scope="col" class="p-2 pb-4 heading-font text-left"><select
                                                        v-model="form.deliveryStatus" id="delivery-status"
                                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                                                        required>
                                                        <option v-for="(status, index) in deliveryStatuses"
                                                            :value="status.value" :key="index">
                                                            {{ status.name }}
                                                        </option>
                                                    </select></th>
                                             ...
                                             <span v-if=" sale.product.delivery != null">
                                                ...
                                                <td class="hover:bg-gray-100 cursor-pointer ml-1  transition ease-in-out duration-200"
                                                    ...
                                                    <delivery-status
                                                        ...
                                                        :productCompound="sale.product" :overdue="sale.product.overdue"
                                                        :is-solo="true" />
                                                </td>
                                                <td v-else>
                                                    -
...
export default {
    ...
    created() {
        ...
        for (let y in this.chartData[0].data) {
            ...
            this.yearlySalesData.datasets[1].data.push(this.chartData[0].data[y].gross)
