                        ...
                        <div class="card w-full sales-table">
                            ...
                            <div class="p-2 mb-2 relative ">
                                <table class="w-full  text-left text-gray-500 dark:text-gray-400">
                                    ...
                                    <tr class="cursor-pointer" @click="navigateToSale(sale.id)"
                                        v-for="(sale,index) in filteredSales" :key="index">
                                        <td class="p-2 text-left">{{ getDate(sale.date * 1000) }}</td>
                                        <td class="p-2 text-left">{{ sale.code }}</td>
                                        <td class="p-2 text-left">{{ sale.client.name }}</td>
                                        ...
                                        <td class="">
                                            <sale-status :status="sale.product.paymentStatus" :is-solo="true"/>
                                        </td>
                                        <td class="">
                                            <delivery-status v-if=" sale.product.delivery != null" class="ml-1"
