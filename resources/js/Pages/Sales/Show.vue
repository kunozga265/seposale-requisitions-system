...
<!--                </div>-->
            ...
            <div class="page-section">
                ...
                <div class="page-section-content">
                    ...
                    <primary-button v-if="sale.data.delivery.status < 2" @click.native="updateDeliveryDialog = true" class="ml-3 mt-2">{{sale.data.delivery.status == 0 ? "Initiate" : "Close"}} Delivery</primary-button>

                    <dialog-modal :show="updateDeliveryDialog" @close="updateDeliveryDialog=false">
                        <template #title>
                            {{sale.data.delivery.status == 0 ? "Initiate" : "Close"}} Delivery
                        </template>
                        ...
                        <template #content>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="flex items-center mb-2">
                                    <input checked id="backdate" type="checkbox" value="" v-model="backdateDeliveryCheck"
                                           class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                    <label for="backdate"
                                           class="ml-1 text-sm font-medium text-gray-900 dark:text-gray-300">Backdate</label>
                                </div>
                                <vue-date-time-picker
                                    v-if="backdateDeliveryCheck"
                                    color="#1a56db"
                                    v-model="deliveryDate"
                                    :min-date="Date((sale.data.delivery.status == 0 ? sale.data.date : sale.data.delivery.dateInitiated)*1000)"
                            ...
                            <div class="mb-4">
                                <div class="flex items-center mb-2">
                                    <input checked id="backdate" type="checkbox" value="" v-model="userCheck"
                                           class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                    <label for="backdate"
                                           class="ml-1 text-sm font-medium text-gray-900 dark:text-gray-300">{{sale.data.delivery.status == 0 ? "Initiated By" : "Delivered By"}}</label>
                                </div>
                        ...
                        <template #footer>
                            <secondary-button @click.native="updateDeliveryDialog=false">
                                Cancel
                            </secondary-button>
                ...
                <div class="p-2 relative overflow-x-auto">
                  <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tr>
                      ...
                      <td class="pt-4 pr-1 text-base font-bold text-right">{{ numberWithCommas(sale.data.total) }}</td>
                    </tr>
                    </tbody>
                  </table>
                </div>
          ...
          <div class="page-section md:col-span-2">
            ...
            <div class="page-section-content">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2">
                <inertia-link :href="route('receipts.show', {id:receipt.id})" v-for="(receipt, index) in sale.data.receipts" :key="index">
                  <div class="app-card">
                ...
                <primary-button @click.native="newReceiptDialog = true" class="ml-3">New Receipt</primary-button>
                    ...
                    <template #content>
                        ...
                        <div class="mb-4">
                            <div class="flex justify-between">
                                ...
                                <div class="flex items-center mb-2">
                                    <input checked id="fullPaymentCheck" type="checkbox" value="" v-model="fullPaymentCheck"
                                           class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                    <label for="fullPaymentCheck"
                                           class="ml-1 text-sm font-medium text-gray-900 dark:text-gray-300">Full Payment</label>
                                </div>
                            </div>
                            <money class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" v-bind="moneyMaskOptions" v-model="form.amount"/>
                            <!--                    <jet-input type="text" class="block w-full" v-model="form.amount"/>-->
                            <div class="mt-1 text-xs text-gray-500" :class="{'text-red-500':!amountValidation}">Balance: MK{{ numberWithCommas(sale.data.balance) }}</div>
                        </div>
  ...
  methods: {
    ...
    updateDelivery() {
      this.form
          .transform(data => ({
            ...data,
            date: this.getTimestampFromDate(this.deliveryDate),
            user_id: this.userId,
          }))
          .post(this.route('sales.update.delivery', {'id': this.sale.data.id}), {
            preserveScroll: true,
