	...
	l21.186-23.834c1.766-2.648,2.648-6.179,1.766-8.828l-25.6-57.379C193.324,138.593,190.676,135.945,187.145,135.945" />
                    ...
                    <div v-if="sale.data.confirmed" class="page-section md:col-span-2">
                        ...
                        <div class="page-section-content">
                            ...
                            <secondary-button
                                v-if="checkRole($page.props.auth.data, 'accountant') || checkRole($page.props.auth.data, 'management')"
                                @click.native="attachReceiptDialog = true" class="ml-3">Attach Receipt
                            </secondary-button>

                            <dialog-modal :show="attachReceiptDialog" @close="attachReceiptDialog = false">
                                <template #title>
                                    New Receipt
                                </template>
                                ...
                                <template #content>
                                    ...
                                    <div class="mb-4">
                                        <jet-label for="receiptCode" value="Receipt Code" />
                                        <jet-input type="text" class="block w-full" v-model="form.receiptCode" />
                                    </div>
                                    <div class="mb-4">
                                        <div class="heading-font text-">Payment Summary;</div>
                                    </div>
                                ...
                                <template #footer>
                                    <secondary-button @click.native="attachReceiptDialog = false">
                                        Cancel
                                    </secondary-button>

                                    <primary-button class="ml-2" @click.native="attachReceipt">
                                        <svg v-show="form.processing" role="status"
                                            class="inline w-4 h-4 mr-3 text-white animate-spin" viewBox="0 0 100 101"
                                            fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
