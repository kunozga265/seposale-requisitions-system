    ...
    <app-layout>
        ...
        <template #actions>
            <inertia-link :href="route('sites.sales.create',{code:site.data.code})">
                ...
                <secondary-button @click.native="addStockDialog=true">
                    Add Stock
                </secondary-button>
            ...
            <dialog-modal :show="addStockDialog" @close="cancelAddStockDialog">
                ...
                <template #content>
                    ...
                    <div class="mb-4">
                        ...
                        <select v-model="form.inventoryId" id="product"
                            ...
                            <option v-for="(inventory, index) in site.data.inventories" :value="inventory.id" :key="index">
                                {{ inventory.name }}
                            </option>
                        </select>
                    </div>
                ...
                <template #footer>
                    ...
                    <primary-button :disabled="form.processing"  v-if="form.inventoryId !== 0" class="ml-2" @click.native="addStock">
        ...
        <div class="mx-9">
            <div v-if="section === 'block'" class="flex">
                <a :href="route('sites.overview',{section:'block', filter:'all'})">
                    <div
                ...
                <a :href="route('sites.overview',{section:'block', filter:'unpaid'})">
                    <div
                ...
                <a :href="route('sites.overview',{section:'block', filter:'partially-paid'})">
                    <div
                        class="ml-1 flex items-center rounded-full py-2 px-3 bg-gray-200 text-gray-600 text-xs font-bold "
                ...
                <a :href="route('sites.overview',{section:'block', filter:'fully-paid'})">
                    <div
                        class="ml-1 flex items-center rounded-full py-2 px-3 bg-gray-200 text-gray-600 text-xs font-bold "
                ...
                <a :href="route('sites.overview',{section:'block', filter:'closed'})">
                    <div
                        class="ml-1 flex items-center rounded-full py-2 px-3 bg-gray-200 text-gray-600 text-xs font-bold "
                ...
                <a :href="route('sites.overview',{section:'block', filter:'discarded'})">
                    <div
                        class="ml-1 flex items-center rounded-full py-2 px-3 bg-gray-200 text-gray-600 text-xs font-bold "
