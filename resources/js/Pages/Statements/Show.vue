    ...
    <app-layout>
        ...
        <div v-if="statement.data.type == 'balance-sheet'" class="py-6">
            <div class="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
                <statement-line @navigate="navigateToAccount" :account-group="currentAssets" />
                <statement-line @navigate="navigateToAccount" :account-group="inventory" />
                ...
                <statement-line @navigate="navigateToAccount" :account-group="equipment" />
                <statement-line @navigate="navigateToAccount" :account-group="intangibleAssets" />
                <statement-line @navigate="navigateToAccount" :account-group="currentLiabilities" />
                <statement-line @navigate="navigateToAccount" :account-group="longTermLiabilities" />
                <statement-line @navigate="navigateToAccount" :account-group="equity" />
        ...
        <div v-if="statement.data.type == 'income-statement'" class="py-6">
            <div class="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
                <statement-line @navigate="navigateToAccount" :account-group="income" />
                <statement-line @navigate="navigateToAccount" :account-group="cogs" />
                ...
                <statement-line @navigate="navigateToAccount" :account-group="marketingExpenses" />
                <statement-line @navigate="navigateToAccount" :account-group="administrativeExpenses" />
                <statement-line @navigate="navigateToAccount" :account-group="otherIncome" />
                <statement-line @navigate="navigateToAccount" :account-group="otherExpenses" />
...
export default {
    ...
    methods: {
        navigateToAccount(account) {
            this.$inertia.get(this.route('statements.account', {'serial':this.statement.data.serial, 'code': account.data.code }))
        },
