                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2">
                                    ...
                                    <div class="p-2 mb-2 ">
                                        ...
                                        <jet-input id="name" type="text" class="block w-full" v-model="form.name"
                                            placeholder="" required autocomplete="seposale-Transporter-name" />
                                    </div>
                                    ...
                                    <div class="p-2 mb-2">
                                        ...
                                        <jet-input id="phone_number" type="text" class="block w-full"
                                            ...
                                            autocomplete="seposale-Transporter-phone_number" />
                                    </div>
                                    ...
                                    <div class="p-2 mb-2">
                                        ...
                                        <jet-input id="phone_number_other" type="text" class="block w-full"
                                            ...
                                            autocomplete="seposale-Transporter-phone_number_other" />
                                    </div>
                                    ...
                                    <div class="p-2 mb-2">
                                        ...
                                        <jet-input id="location" type="text" class="block w-full"
                                            v-model="form.location" autocomplete="seposale-Transporter-location" />
                                    </div>
