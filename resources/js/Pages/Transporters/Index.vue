    ...
    <template #breadcrumbs>
      <li aria-current="page">
        <div class="flex items-center">
          ...
          <span class="heading-font uppercase text-sm font-medium text-gray-500 dark:text-gray-400">Transporters</span>
        </div>
      </li>
    </template>
    ...
    <dialog-modal :show="editDialog" @close="editDialog = false">
      ...
      <template #content>
        ...
        <div class="p-2 mb-2 md:col-span-2">
          ...
          <select v-model="transporterIndex"
        ...
        <div v-if="transporter != null" class="grid grid-cols-1 md:grid-cols-2">
          ...
          <div class="p-2 mb-2">
            ...
            <jet-input id="phone_number" type="text" class="block w-full" v-model="form.phone_number" placeholder=""
              required autocomplete="seposale-Transporter-phone_number" />
          </div>
          ...
          <div class="p-2 mb-2">
            ...
            <jet-input id="phone_number_other" type="text" class="block w-full" v-model="form.phone_number_other"
              placeholder="" autocomplete="seposale-Transporter-phone_number_other" />
          </div>

          <div class="p-2 mb-2">
            <jet-label for="email" value="Email" />
            <jet-input id="email" type="email" class="block w-full" v-model="form.email"
              autocomplete="seposale-Transporter-email" />
          </div>

          <div class="p-2 mb-2">
            <jet-label for="location" value="Location" />
            <jet-input id="location" type="text" class="block w-full" v-model="form.location"
              autocomplete="seposale-Transporter-location" />
          </div>

          <div class="p-2 mb-2">
            <jet-label for="registration_number" value="Registration Number" />
            <jet-input id="registration_number" type="text" class="block w-full" v-model="form.registration_number"
              autocomplete="seposale-Transporter-registration_number" />
          </div>

          <div class="p-2 mb-2">
            <jet-label for="type" value="Type" />
            <jet-input id="type" type="text" class="block w-full" v-model="form.type"
              autocomplete="seposale-Transporter-type" />
          </div>

          <div class="p-2 mb-2">
            <jet-label for="make" value="Make" />
            <jet-input id="make" type="text" class="block w-full" v-model="form.make"
              autocomplete="seposale-Transporter-make" />
          </div>
        </div>
      ...
      <template #footer>
        ...
        <primary-button v-show="editValidation" class="ml-2" @click.native="editTransporter"
      ...
      <div class="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
        ...
        <div class="page-section">
          ...
          <div class="page-section-content">
            ...
            <div v-if="transporters.data.length === 0" class="text-center text-gray-400 md:col-span-2 text-sm">
                ...
                <div class="p-2 mb-2 relative ">
                  ...
                  <table class="w-full  text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody class="pt-8">
                      ...
                      <tr @click="navigateToTransporter(transporter.id)"
  ...
  watch: {
    transporterIndex() {
      if (this.transporterIndex < 0) {
        ...
        const transporter = this.filteredTransporters[this.transporterIndex]
        this.transporter = transporter
        this.form.name = transporter.name
        this.form.phone_number = transporter.phoneNumber
        this.form.phone_number_other = transporter.phoneNumberOther
        this.form.email = transporter.email
        this.form.location = transporter.location
        this.form.registration_number = transporter.registrationNumber
        this.form.type = transporter.type
        this.form.make = transporter.make
      }
    }
  },
  methods: {
    ...
    editTransporter() {
      this.form
        ...
        .post(this.route('transporters.update', { 'id': this.transporter.id }), {
          onSuccess: () => {
            this.editDialog = false
            this.transporterIndex = -1
          },
        })
    },
