                            ...
                            <div class="card w-full sm:max-w-md md:max-w-3xl">
                                ...
                                <div class="p-2 mb-2 md:col-span-2">
                                    ...
                                    <select v-model="form.templateId"
                                        ...
                                        <option :value="template.id" v-for="(template, index) in templates"
                                            :key="index">
                                            {{ template.name }}
                                        </option>
                                    </select>

                                    <div v-show="hasFile" class="mt-2 md:col-span-2">
                                        <div class="text-mute text-sm mb-1">
                                            Upload Template File
                                        </div>
                                        <input type="file" id="photo"
                                            @input="templateFileUpload($event.target.files[0])" accept="image/*, .pdf"
