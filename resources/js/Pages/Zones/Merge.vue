                            ...
                            <div class="card w-full sm:max-w-md md:max-w-3xl">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2">
                                       ...
                                       <div class="p-2 mb-2" :class="{ 'md:col-span-2': form.clientTypeId != 0 }">
                                        <jet-label for="clientType" value="Reference Client" />
                                        <select v-model="selectedClientId" id="clientType"
                                    ...
                                    <div v-show="form.clientTypeId == 0" class="p-2 mb-2">
                                        ...
                                        <jet-input id="other" type="text" class="block w-full"
                                            v-model="form.clientType" autocomplete="seposale-customer-type" />
                                    </div>
...
export default {
    ...
    mounted() {
        ...
        this.setClient(this.selectedClientId)
    ...
    methods: {
        submit() {
            this.form
                ...
                .post(this.route('clients.merge-list'))
        },
        setClient(id){
            const client = this.clients.find(c => c.id === id)
            this.form.name = client.name
            this.form.phoneNumber = client.phone_number
            this.form.phoneNumberOther = client.phone_number_other
            this.form.email = client.email
            this.form.address = client.address
            this.form.clientTypeId = client.client_type_id
            this.form.alias = client.alias
            this.form.organisation = client.organisation
