...
Route::group(['middleware' => ['auth:sanctum', 'verified', 'roles']], function () {
    ...
    Route::group(['prefix' => 'inventories'], function () {
        ...
        Route::post('/update', [
            "uses"  => "App\Http\Controllers\InventoryController@addStock",
            'roles' => ['employee', 'management']
        ])->name('inventories.add-stock');
    });
    ...
    Route::group(['prefix' => 'credit-vouchers'], function () {

        Route::get('/', [
            "uses"  => "App\Http\Controllers\CreditVoucherController@index",
            'roles' => ['accountant', 'management']
        ])->name('credit-vouchers.index');

        Route::get('/view/{id}', [
            "uses"  => "App\Http\Controllers\CreditVoucherController@show",
            'roles' => ['employee', 'management']
